STRINGS = {
    ...
    "bot.date_modified": "Değiştirilme tarihi",
    ...
    "bot.total": "Toplam",
    "bot.update": "Yeni bir güncellemem var **{0}**! işte değişiklikler:",
    ...
    "error.cooldown": "Bu komutu tekrar kullanman için {0:.01f}s beklemen lazım..",
    "error.faction_not_found": "Bu birlik bulunamadı.",
    "error.http": "Veri alırken bir hata oluştu. Daha sonra tekrar deneyin.",
    "error.http_canvas": "{0} bağlantı sorunları yaşıyor gibi görünüyor. Daha sonra tekrar deneyin.",
    "error.invalid_color": "Bu geçerli bir renk değil.",
    "error.invalid_option": "Bu geçerli bir seçenek değil. Lütfen tekrar deneyin.",
    "error.jpeg": "Cidden mi? Bir JPEG? Lütfen .PNG uzantılı bir şablon oluştur.",
    "error.no_attachment": "Bu komut bir dosya gerektirir.",
    "error.no_dm": "Bu komut sadece birliklerde çalışıyor.",
    "error.no_self_permission": "Bunu yapabilmek için bu kanalda yeterli izne sahip değilim.",
    ...
    "error.unknown": "Bilinmeyen bir hata oluştu. Geliştiriciye bildirildi.",
    "error.why": "Ama... Neden?",

    # Animotes command messages
    "animotes.opt_in": "**Emoji dönüşümünü** başarıyla seçtiniz.",
    "animotes.opt_out": "**Emoji dönüşümünü** başarılı bir şekilde seçtiniz.",
    ...
    "canvas.repeat_not_found": "Tekrar edilecek bir komut bulunamadı.",
    ...
    "faction.clear_alias": "Hizip takma adı temizlendi.",
    "faction.clear_color": "Hizip rengi temizlendi.",
    "faction.clear_description": "Hizip açıklaması temizlendi.",
    ...
    "template.added": "Şablon '{0}' eklendi!",
    ...
    "help.gridify": "Bir resmi 4 milyondan fazla piksel içerecek şekilde yakınlaştıramazsınız.",
    "help.prefix": "Maksimum uzunluk 5 karakterdir. Gerçekten 2'den fazlaya ihtiyacınız yok.",
    "help.preview": "Maksimum zoom 16'dır. Minimum zoom -8'dir.",
    "help.quantize":
    ...
    "signature.quantize.pixelcanvas": ["", "<şablon>"],
    "signature.quantize.pixelzio": ["", "<şablon>"],
    "signature.quantize.pixelzone": ["", "<şablon>"],
    "signature.quantize.pxlsspace": ["", "<şablon>"],
    "signature.role": "(role)",
    ...
    "color.pixelcanvas.1": "Açık Gri",
    "color.pixelcanvas.2": "Kapalı Gri",
    "color.pixelcanvas.3": "Siyah",
    "color.pixelcanvas.4": "Pembe",
    "color.pixelcanvas.5": "Kırmızı",
    "color.pixelcanvas.6": "Turuncu",
    "color.pixelcanvas.7": "Kahverengi",
    "color.pixelcanvas.8": "Sarı",
    "color.pixelcanvas.9": "Açık Yeşil",
    "color.pixelcanvas.10": "Yeşil",
    "color.pixelcanvas.11": "Açık Mavi",
    "color.pixelcanvas.12": "Çamurçun",
    "color.pixelcanvas.13": "Mavi",
    "color.pixelcanvas.14": "Açık Mor",
    "color.pixelcanvas.15": "Mor",

    "color.pixelzio.0": "Beyaz",
    "color.pixelzio.1": "Açık Gri",
    "color.pixelzio.2": "Kapalı Gri",
    "color.pixelzio.3": "Siyah",
    "color.pixelzio.4": "Pembe",
    "color.pixelzio.5": "Kırmızı",
    "color.pixelzio.6": "Turuncu",
    "color.pixelzio.7": "Kahverengi",
    "color.pixelzio.8": "Sarı",
    "color.pixelzio.9": "Açık Yeşil",
    "color.pixelzio.10": "Yeşil",
    "color.pixelzio.11": "Açık Mavi",
    "color.pixelzio.12": "Çamurçun",
    "color.pixelzio.13": "Mavi",
    "color.pixelzio.14": "Açık Mor",
    "color.pixelzio.15": "Mor",

    "color.pixelzone.0": "Kapalı Gri",
    "color.pixelzone.1": "Siyah",
    "color.pixelzone.2": "Açık Gri",
    "color.pixelzone.3": "Beyaz",
    "color.pixelzone.4": "Kahverengi",
    "color.pixelzone.5": "Pembe",
    "color.pixelzone.6": "Açık Mor",
    "color.pixelzone.7": "Mor",
    "color.pixelzone.8": "Kırmızı",
    "color.pixelzone.9": "Turuncu",
    "color.pixelzone.10": "Sarı",
    "color.pixelzone.11": "Açık Yeşil",
    "color.pixelzone.12": "Yeşil",
    "color.pixelzone.13": "Açık Mavi",
    "color.pixelzone.14": "Çamurçun",
    "color.pixelzone.15": "Mavi",

    "color.pxlssapce.0": "Beyaz",
    "color.pxlssapce.1": "Hafif Gri",
    "color.pxlssapce.2": "Orta Açık Gri",
    "color.pxlssapce.3": "Orta Kapalı Gri",
    "color.pxlssapce.4": "Kapalı Gri",
    "color.pxlssapce.5": "Siyah",
    "color.pxlssapce.6": "Pembe",
    "color.pxlssapce.7": "Kırmızı",
    "color.pxlssapce.8": "Kestane rengi",
    "color.pxlssapce.9": "Bej",
    "color.pxlssapce.10": "Taba",
    "color.pxlssapce.11": "Turuncu",
    "color.pxlssapce.12": "Açık Kahverengi",
    "color.pxlssapce.13": "Kapalı Kahverengi",
    "color.pxlssapce.14": "Sarı",
    "color.pxlssapce.15": "Açık Yeşil",
    "color.pxlssapce.16": "Orta Yeşil",
    "color.pxlssapce.17": "Kapalı Yeşil",
    "color.pxlssapce.18": "Açık Mavi",
